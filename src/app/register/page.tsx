...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Auto sign-in or prompt user to check email if confirm email is enabled
      ...
      <div className="relative z-10 w-full max-w-[440px] transition-all duration-500">
        ...
        <div className="bg-[#12131C]/40 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-8 md:p-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-white mt-1">Sign up Account</h1>
            <p className="text-xs text-neutral-400 mt-1.5">Build habits, track workouts, see progress</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest pl-1" htmlFor="name">Full Name</label>
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 h-4.5 w-4.5" />
                <input 
                  className="bg-black/35 border border-white/10 rounded-xl px-4 py-3 pl-11 w-full text-white text-xs focus:outline-none focus:border-[#a9abff] focus:ring-1 focus:ring-[#a9abff] transition-all placeholder:text-neutral-600 shadow-[inset_0_1px_2px_rgba(0,0,0,0.4)]" 
                  id="name" 
                  type="text"
            ...
            {/* Password Field */}
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest pl-1" htmlFor="password">Password</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 h-4.5 w-4.5" />
                <input 
                  className="bg-black/35 border border-white/10 rounded-xl px-4 py-3 pl-11 pr-11 w-full text-white text-xs focus:outline-none focus:border-[#a9abff] focus:ring-1 focus:ring-[#a9abff] transition-all placeholder:text-neutral-600 shadow-[inset_0_1px_2px_rgba(0,0,0,0.4)]" 
                  id="password" 
            ...
            <div className="flex items-start gap-2.5 pt-1.5">
              <div className="flex items-center h-5">
                <input 
                  className="w-4 h-4 rounded border-white/20 bg-black text-[#6366F1] focus:ring-[#6366F1] focus:ring-offset-black" 
                  id="terms" 
                  type="checkbox"
                  checked={agreeTerms}
              ...
              <label className="text-[11px] text-neutral-400 leading-normal" htmlFor="terms">
                I agree to the <a className="text-white hover:underline font-medium" href="#">Terms</a> and <a className="text-white hover:underline font-medium" href="#">Privacy Policy</a>.
              </label>
            </div>
