...
import { ArrowRight, Mail, Lock, Sun, Moon, Triangle } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="bg-[#111114]/65 dark:bg-[#111114]/65 light:bg-white border border-white/[0.08] dark:border-white/[0.08] light:border-slate-200 rounded-[28px] p-8 md:p-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] dark:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] light:shadow-[0_20px_40px_rgba(0,0,0,0.04)] relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-xl font-extrabold tracking-tight mt-1 text-white dark:text-white light:text-slate-800">Welcome Back</h1>
            <p className="text-[11px] text-neutral-400 dark:text-neutral-400 light:text-slate-500 mt-1">Crush goals, log workouts, master your day</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center px-1">
                <label className="text-[9px] font-bold text-neutral-400 dark:text-neutral-400 light:text-slate-500 uppercase tracking-widest" htmlFor="password">Password</label>
                <a className="text-[9px] font-semibold text-neutral-400 dark:text-neutral-400 light:text-slate-500 hover:text-white dark:hover:text-white light:hover:text-black transition-colors" href="#">Forgot?</a>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-xs text-neutral-400 dark:text-neutral-400 light:text-slate-500 mt-8">
            ...
            <Link href="/register" className="text-[#A78BFA] hover:underline font-bold">
              Sign Up
            </Link>
          </p>
