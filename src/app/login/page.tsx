      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="bg-white dark:bg-[#111114]/65 border border-slate-200 dark:border-white/[0.08] rounded-[28px] p-8 md:p-10 shadow-[0_20px_40px_rgba(0,0,0,0.04)] dark:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-xl font-extrabold tracking-tight mt-1 text-slate-800 dark:text-white">Welcome Back</h1>
            <p className="text-[11px] text-slate-500 dark:text-neutral-400 mt-1">Crush goals, log workouts, master your day</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center px-1">
                <label className="text-[9px] font-bold text-slate-500 dark:text-neutral-400 uppercase tracking-widest" htmlFor="password">Password</label>
                <a className="text-[9px] font-semibold text-slate-500 dark:text-neutral-400 hover:text-black dark:hover:text-white transition-colors" href="#">Forgot?</a>
              </div>
              <div className="relative">
